...
public class DorianDerDrogendealer
{
    ...
    {
        System.out.println("You got the following things in your inventory:");
        System.out.println("1. speed");
        System.out.println("2. cocaine");
        System.out.println("3. mdma");
        System.out.println("4. weed");
        System.out.println("5. ecstasy");
        System.out.println("6. shrooms");
    }
                    ...
                    else if(colour==1 && chape !=1)
                    {
                        ...
                        switch (option)
                        {
                            case RUN:
                                ...
                                System.exit(0);
                            case SHOOT:
                            System.out.println("You escaped because they were too scared to continue running after you. But no one got hurt because your shots were inaccurate as fuck... Next time remember to take you Desert Eagle instead of your R8...");
                                return;
                            case DROP_ITEMS:
